...
# def get_data(indicators, fields: list):
#     df = pd.read_parquet(indicators, filters=[('code', 'in', fields)], engine='pyarrow')
#     df = df.pivot_table(index='date', columns='code', values='value')
#     df = df.filter(fields)
#     return df
#
...
def get_cohort(assets: list, benchmark: str):
    individual_assets = get_data(indicators, fields=assets)
    ...
    df_benchmark = get_data(indicators, fields=[benchmark])
...
def show_chartbook():
    ...
    if selected_category == "Estados Unidos":
        display_chart_with_expander(
            "PIB :heavy_dollar_sign: :chart:",
            ["PIB", "PIB (% YoY)", "PIB (% QoQ)"],
            ["line", "bar", "bar"],
            [
                get_data(indicators, fields=["us_gdp_index"]),
                get_data(indicators, fields=["us_gdp_yoy"]),
                get_data(indicators, fields=["us_gdp_qoq"]),
            ]
        )

        display_chart_with_expander(
            "Taxas Referenciais :chart:",
            ["Curva Pré (Treasuries)", "Curva Inflação (TIPS)", "Curva Implícita (Breakeven)", "Curva de Juros",
             "Inclinações"],
            ["line", "line", "line", "line", "line"],
            [
                get_data(indicators, fields=["us_generic_2y", "us_generic_5y", "us_generic_10y", "us_generic_30y"]),
                get_data(indicators, fields=["us_generic_inflation_5y", "us_generic_inflation_10y", "us_generic_inflation_20y",
                ...
                get_data(indicators, fields=["us_2y10y_steepness", "us_5y10y_steepness", "us_5y30y_steepness"]),
            ],
            connect_gaps=True
        )

        display_chart_with_expander(
            "Taxas Corporativas :chart:",
            ["IG Spreads", "IG Taxas", "HY Spreads", "HY Taxas"],
            ["line", "line", "line", "line"],
            [
                get_data(indicators, fields=["us_corporate_ig_5y_spread", "us_corporate_ig_10y_spread"]),
                get_data(indicators, fields=["us_corporate_ig_5y_yield", "us_corporate_ig_10y_yield"]),
                get_data(indicators, fields=["us_corporate_hy_5y_spread", "us_corporate_hy_10y_spread"]),
                get_data(indicators, fields=["us_corporate_hy_5y_yield", "us_corporate_hy_10y_yield"])
            ]
        )
        ...
        display_chart_with_expander(
            ...
            [
                ...
                get_data(indicators, fields=["us_advance_retail_sales_total_yoy", "us_advance_retail_sales_ex_auto_yoy"]),
            ]
        )
        ...
        display_chart_with_expander(
            "Atividade Econômica :heavy_dollar_sign:",
            ["Índice de Condições Financeiras", "Índice de Stress Financeiro"],
            ["line", "line"],
            [
                get_data(indicators, fields=["us_fed_national_fci", "us_fed_adjusted_national_fci"]),
                get_data(indicators, fields=["us_fed_financial_stress_index"]),
            ]
        )

        display_chart_with_expander(
            "Emprego :heavy_dollar_sign:",
            ...
            [
                ...
                get_data(indicators, fields=["us_adp_nonfarm_employment"]).diff().merge(
                    ...
                    how='outer'),
                get_data(indicators, fields=["us_adp_nonfarm_employment_yoy", "us_employees_nonfarm_payrolls_yoy"]),
                get_data(indicators, fields=["us_average_hourly_earnings"]),
        ...
        display_chart_with_expander(
            ...
            ["line", "bar", "bar"],
            [
                get_data(indicators, fields=["br_gdp_index"]),
                get_data(indicators, fields=["br_gdp_yoy"]),
                get_data(indicators, fields=["br_gdp_qoq"]),
            ]
        )
        ...
        display_chart_with_expander(
            ...
            ["line", "line", "line", "line"],
            [
                get_data(indicators, fields=["br_pre_1y", "br_pre_2y", "br_pre_3y", "br_pre_5y", "br_pre_10y"]),
                get_data(indicators, fields=["br_ipca_1y", "br_ipca_2y", "br_ipca_3y", "br_ipca_5y", "br_ipca_10y", "br_ipca_35y"]),
                get_data(indicators, fields=["br_breakeven_1y", "br_breakeven_2y", "br_breakeven_3y", "br_breakeven_5y",
                                 "br_breakeven_10y"]),
        ...
        display_chart_with_expander(
            ...
            [
                get_data(indicators, fields=["br_ipca_yoy"]).merge(
        ...
        display_chart_with_expander(
            ...
            ["line", "line", "bar", "bar"],
            [
                get_data(indicators, fields=["br_industrial_production"]),
                get_data(indicators, fields=["br_industrial_production_12m_yoy"]),
                get_data(indicators, fields=["br_industrial_production_yoy"]),
                get_data(indicators, fields=["br_industrial_production_mom"]),
            ]
        )

        display_chart_with_expander(
            "Contas Públicas :heavy_dollar_sign:",
            ["Dívida (% do PIB)", "Resultado Fiscal (% do PIB)"],
            ["line", "line"],
            [
                get_data(indicators, fields=["br_bcb_gross_gov_debt_to_gdp", "br_bcb_net_gov_debt_to_gdp",
                                 "br_bcb_net_public_sector_debt_to_gdp"]),
                get_data(indicators, fields=["br_bcb_primary_result_12m_to_gdp", "br_bcb_nominal_result_12m_to_gdp"]),
            ]
        )

        display_chart_with_expander(
            "Balança Comercial :heavy_dollar_sign: :chart:",
            ...
            [
                get_data(indicators, fields=["br_citi_terms_of_trade_index", "br_current_account_to_gdp"]),
                get_data(indicators, fields=["br_mdic_terms_of_trade_index", "br_current_account_to_gdp"]),
                get_data(indicators, fields=["br_trade_balance_fob_exports", "br_trade_balance_fob_imports"]),
                get_data(indicators, fields=["br_trade_balance_fob_exports", "br_trade_balance_fob_imports"]).resample("Y").sum(),
                get_data(indicators, fields=["br_trade_balance_fob_exports", "br_trade_balance_fob_imports"]).rolling(
                    12).sum().dropna(),
                get_data(indicators, fields=["br_trade_balance_fob_t12"]),
            ],
            connect_gaps=True
        )

        display_chart_with_expander(
            "Serviços (PMS) :heavy_dollar_sign:",
            ...
            [
                get_data(indicators, fields=["br_pms_services_volume_total_index"]),
                get_data(indicators, fields=["br_pms_services_volume_total_index"]),
                get_data(indicators, fields=["br_pms_services_volume_total_yoy"]),
                get_data(indicators, fields=["br_pms_services_volume_total_mom"]),
                get_data(indicators, fields=["br_pms_services_volume_total_index", "br_pms_services_volume_administrative_index",
        ...
        display_chart_with_expander(
            "Varejo (PMC) :heavy_dollar_sign:",
            ["Volume de Vendas", "Volume de Vendas (% YoY)", "Evolução por Atividade"],
            ["line", "bar", "line"],
            [
                get_data(indicators, fields=["br_pmc_retail_sales_volume_total_index",
        ...
        display_chart_with_expander(
            ...
            ["line", "line", "line", "line"],
            [
                get_data(indicators, fields=["br_fgv_consumer_confidence_current_situation_index",
                                 "br_fgv_consumer_confidence_expectations_index", "br_fgv_consumer_confidence_index"]),
                get_data(indicators, fields=["br_fgv_business_confidence_current_situation_index",
                                 "br_fgv_business_confidence_expectations_index", "br_fgv_business_confidence_index"]),
                get_data(indicators, fields=["br_fgv_industrial_confidence_current_situation_index",
                                 "br_fgv_industrial_confidence_expectations_index",
                                 "br_fgv_industrial_confidence_index"]),
                get_data(indicators, fields=["br_fgv_economic_uncertainty_index"]),
            ]
        )
        ...
        display_chart_with_expander(
            ...
            ["line", "bar", "bar"],
            [
                get_data(indicators, fields=["br_ibcbr_index"]),
                get_data(indicators, fields=["br_ibcbr_yoy"]),
                get_data(indicators, fields=["br_ibcbr_qoq"]),
            ]
        )
        ...
        display_chart_with_expander(
            ...
            ["bar", "bar", "line"],
            [
                get_data(indicators, fields=["br_caged_registered_employess_total"]).diff(),
                get_data(indicators, fields=["br_caged_registered_employess_total"]).diff().rolling(12).sum(),
                get_data(indicators, fields=["br_pnad_unemployment_rate"]),
            ]
        )
        ...
        display_chart_with_expander(
            ...
            ["line", "line", "line", "line", "line"],
            [
                get_data(indicators, fields=["br_bcb_credit_outstanding_total", "br_bcb_credit_outstanding_pf",
                                 "br_bcb_credit_outstanding_pj"]),
                get_data(indicators, fields=["br_bcb_nonearmarked_credit_outstanding_pj", "br_bcb_earmarked_credit_outstanding_pj",
                                 "br_bcb_nonearmarked_credit_outstanding_pf",
                                 "br_bcb_earmarked_credit_outstanding_pf"]),
                get_data(indicators, fields=["br_bcb_credit_outstanding_total", "br_bcb_credit_outstanding_msme",
                                 "br_bcb_credit_outstanding_corporate"]),
                get_data(indicators, fields=["br_bcb_average_interest_rate_total", "br_bcb_average_interest_rate_pf",
                                 "br_bcb_average_interest_rate_pj", "br_selic_target"]),
                get_data(indicators, fields=["br_bcb_past_due_loans_pf", "br_bcb_past_due_loans_pj"]),
            ],
            connect_gaps=True
        )

        display_chart_with_expander(
            "Tráfego :heavy_dollar_sign:",
            ["Fluxo Pedagiado nas Estradas", "Fluxo Pedagiado nas Estradas (% YoY)"],
            ["line", "bar"],
            [
                get_data(indicators, fields=["br_abcr_traffic_heavy_vehicles", "br_abcr_traffic_light_vehicles"]),
                get_data(indicators, fields=["br_abcr_traffic_heavy_vehicles_yoy", "br_abcr_traffic_light_vehicles_yoy"]),
            ]
        )
        ...
        display_chart_with_expander(
            ...
            ["line", "line", "line", "line"],
            [
                get_data(indicators, fields=["germany_generic_1y", "spain_generic_1y", "france_generic_1y", "italy_generic_1y",
                                 "japan_generic_1y",
                                 "switzerland_generic_1y", "sweden_generic_1y"]),
                get_data(indicators, fields=["germany_generic_5y", "spain_generic_5y", "france_generic_5y", "italy_generic_5y",
                                 "japan_generic_5y",
                                 "switzerland_generic_5y", "sweden_generic_5y"]),
                get_data(indicators, fields=["new_zealand_generic_1y", "australia_generic_1y", "canada_generic_1y",
                                 "norway_generic_1y",
                                 "us_generic_1y", "uk_generic_1y"]),
                get_data(indicators, fields=["new_zealand_generic_5y", "australia_generic_5y", "canada_generic_5y",
                                 "norway_generic_5y",
        ...
        display_chart_with_expander(
            ...
            ["line", "line", "line", "line"],
            [
                get_data(indicators, fields=["china_generic_1y", "chile_generic_1y", "colombia_generic_1y", "hungary_generic_1y",
                                 "poland_generic_1y", "peru_generic_1y"]),
                get_data(indicators, fields=["china_generic_5y", "chile_generic_5y", "colombia_generic_5y", "hungary_generic_5y",
                                 "poland_generic_5y", "peru_generic_5y"]),
                get_data(indicators, fields=["south_africa_generic_1y", "russia_generic_1y", "br_generic_1y", "mexico_generic_1y",
                                 "india_generic_1y", "indonesia_generic_1y", "turkey_generic_1y"]),
                get_data(indicators, fields=["south_africa_generic_5y", "russia_generic_5y", "br_generic_5y", "mexico_generic_5y",
        ...
        display_table_with_expander(
            ...
            ["Energia", "Metais"],
            [
                get_data(indicators, fields=["crude_oil_wti", "crude_oil_brent", "gasoline", "usda_diesel", "natural_gas",
                                 "thermal_coal"]).ffill(limit=2),
                get_data(indicators, fields=["gold", "silver", "lme_aluminum", "lme_copper", "lme_nickel_cash", "sgx_iron_ore_62",
        ...
        display_chart_with_expander(
            "Commodity Research Bureau (CRB) :chart:",
            ["Índice CRB (2019 = 100)", "Índice CRB (% 12 meses)"],
            ["line", "line"],
            [
                scale_to_100(date="2019", df=get_data(indicators, 
                ...
                get_data(indicators, fields=["crb_index"]).pct_change(252).dropna(),
            ],
            connect_gaps=True
        )
        ...
        display_chart_with_expander(
            ...
            ["line"],
            [
                get_data(indicators, fields=["baltic_dry_index", "shanghai_containerized_freight_index"])
            ],
            connect_gaps=True
        )

        display_chart_with_expander(
            "Combustível :heavy_dollar_sign:",
            ["Atacado (2019 = 100)", "Varejo (2019 = 100)"],
            ["line", "line"],
            [
                scale_to_100(date="2019", df=get_data(indicators, fields=["crude_oil_brent", "crude_oil_wti", "gasoline",
                                                              "usda_diesel"])),
                scale_to_100(date="2019", df=get_data(indicators, fields=["br_anp_gasoline_retail", "br_anp_diesel_retail",
        ...
        display_chart_with_expander(
            ...
            ["bar", "bar", "bar", "bar"],
            [
                get_data(indicators, fields=["cftc_cbt_treasury_2y"]),
                get_data(indicators, fields=["cftc_cbt_treasury_5y"]),
                get_data(indicators, fields=["cftc_cbt_treasury_10y"]),
                get_data(indicators, fields=["cftc_cbt_treasury_bonds"]),
            ]
        )
        ...
        display_chart_with_expander(
            ...
            ["bar", "bar", "bar", "bar"],
            [
                get_data(indicators, fields=["cftc_cmx_copper"]),
                get_data(indicators, fields=["cftc_cmx_gold"]),
                get_data(indicators, fields=["cftc_cmx_silver"]),
                get_data(indicators, fields=["cftc_nyme_crude_oil"]),
            ]
        )
        ...
        display_chart_with_expander(
            ...
            [
                get_data(indicators, fields=["cftc_cme_aud"]),
                get_data(indicators, fields=["cftc_cme_brl"]),
                get_data(indicators, fields=["cftc_cme_cad"]),
                get_data(indicators, fields=["cftc_cme_chf"]),
                get_data(indicators, fields=["cftc_cme_eur"]),
                get_data(indicators, fields=["cftc_cme_gbp"]),
                get_data(indicators, fields=["cftc_cme_jpy"]),
                get_data(indicators, fields=["cftc_cme_mxn"]),
                get_data(indicators, fields=["cftc_cme_nzd"]),
                get_data(indicators, fields=["cftc_cme_rub"]),
                get_data(indicators, fields=["cftc_cme_zar"]),
            ]
        )
        ...
        display_chart_with_expander(
            ...
            ["bar", "bar", "bar", "bar"],
            [
                get_data(indicators, fields=["cftc_cme_sp500"]),
                get_data(indicators, fields=["cftc_cme_nasdaq"]),
                get_data(indicators, fields=["cftc_cme_nikkei"]),
                get_data(indicators, fields=["cftc_cme_russell2000"]),
            ]
        )
        ...
        display_chart_with_expander(
            ...
            ["line", "line"],
            [
                get_data(indicators, fields=["us_sp500"]).assign(ma_200=lambda x: x['us_sp500'].rolling(200).mean(),
                                                     ma_50=lambda x: x['us_sp500'].rolling(50).mean()),
                get_data(indicators, fields=["br_ibovespa"]).assign(ma_200=lambda x: x['br_ibovespa'].rolling(200).mean(),
